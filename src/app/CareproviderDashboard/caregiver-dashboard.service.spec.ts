...
import { CaregiverdashboardComponent } from './caregiverdashboard/caregiverdashboard.component';

describe('CaregiverDashboardService', () => {
  let service: CaregiverDashboardService;
  ...
  beforeEach(() => {
    ...
    service = TestBed.inject(CaregiverDashboardService);
  });
