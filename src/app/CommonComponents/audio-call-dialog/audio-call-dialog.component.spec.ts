...
import { AudioCallDialogComponent } from './audio-call-dialog.component';

describe('AudioCallDialogComponent', () => {
  let component: AudioCallDialogComponent;
  let fixture: ComponentFixture<AudioCallDialogComponent>;
  let appModule = new AppModule();
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [AudioCallDialogComponent],
      imports: [
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(AudioCallDialogComponent);
