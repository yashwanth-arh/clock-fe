...
import { BGAdherenceChartComponent } from './bg-adherence-chart.component';

describe('BGAdherenceChartComponent', () => {
  let component: BGAdherenceChartComponent;
  let fixture: ComponentFixture<BGAdherenceChartComponent>;
  let appModule = new AppModule();
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [BGAdherenceChartComponent],
      imports: [
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(BGAdherenceChartComponent);
