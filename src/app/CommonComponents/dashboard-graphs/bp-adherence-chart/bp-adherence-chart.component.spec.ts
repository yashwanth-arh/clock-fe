...
import { BpAdherenceChartComponent } from './bp-adherence-chart.component';
...
describe('BpAdherenceChartComponent', () => {
  let component: BpAdherenceChartComponent;
  let fixture: ComponentFixture<BpAdherenceChartComponent>;
  let appModule = new AppModule();
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [BpAdherenceChartComponent],
      imports: [
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(BpAdherenceChartComponent);
