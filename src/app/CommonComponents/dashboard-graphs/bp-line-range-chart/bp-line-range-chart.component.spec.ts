...
import { BpLineRangeChartComponent } from './bp-line-range-chart.component';

describe('BpLineRangeChartComponent', () => {
  let component: BpLineRangeChartComponent;
  let fixture: ComponentFixture<BpLineRangeChartComponent>;
  let appModule = new AppModule();
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [BpLineRangeChartComponent],
      imports: [
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(BpLineRangeChartComponent);
