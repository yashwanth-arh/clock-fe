...
import { BpTrendPieChartComponent } from './bp-trend-pie-chart.component';

describe('BpTrendPieChartComponent', () => {
  let component: BpTrendPieChartComponent;
  let fixture: ComponentFixture<BpTrendPieChartComponent>;
  let appModule = new AppModule();
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [BpTrendPieChartComponent],
      imports: [
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(BpTrendPieChartComponent);
