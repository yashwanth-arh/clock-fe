...
import { MedicationAdherenceChartComponent } from './medication-adherence-chart.component';
...
describe('MedicationAdherenceChartComponent', () => {
  let component: MedicationAdherenceChartComponent;
  let fixture: ComponentFixture<MedicationAdherenceChartComponent>;
  let appModule = new AppModule();
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [MedicationAdherenceChartComponent],
      imports: [
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(MedicationAdherenceChartComponent);
