...
import { DoctorPatientsDetailsComponent } from './doctor-patients-details.component';

describe('DoctorPatientsDetailsComponent', () => {
  let component: DoctorPatientsDetailsComponent;
  let fixture: ComponentFixture<DoctorPatientsDetailsComponent>;
  let appModule = new AppModule();
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [DoctorPatientsDetailsComponent, HeightPipe],
      imports: [
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(DoctorPatientsDetailsComponent);
