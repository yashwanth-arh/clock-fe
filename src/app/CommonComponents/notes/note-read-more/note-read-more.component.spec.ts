...
import { NoteReadMoreComponent } from './note-read-more.component';

describe('NoteReadMoreComponent', () => {
  let component: NoteReadMoreComponent;
  let fixture: ComponentFixture<NoteReadMoreComponent>;
  let appModule = new AppModule();

  let matDialogRefSpy: jasmine.SpyObj<MatDialogRef<NoteReadMoreComponent>>;
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      declarations: [NoteReadMoreComponent],
      imports: [
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(NoteReadMoreComponent);
  ...
  it('should display the comments', () => {
    const commentsEl = fixture.nativeElement.querySelector('.comments');
    expect(commentsEl.textContent).toContain(mockData.comments);
  });
