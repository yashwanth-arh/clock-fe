...
import { ObservationHistoryComponent } from './observation-history.component';

describe('ObservationHistoryComponent', () => {
  let component: ObservationHistoryComponent;
  let fixture: ComponentFixture<ObservationHistoryComponent>;
  let appModule = new AppModule();
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [ObservationHistoryComponent],
      imports: [
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(ObservationHistoryComponent);
