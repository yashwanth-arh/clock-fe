...
export class AlertComponent implements OnInit {
  ...
  ngAfterViewInit() {
    // setTimeout(() => {
    this.caregiverSharedService.triggeredalertTabsCount.subscribe((value) => {
      if (value) {
        this.alertZonePatCount = localStorage.getItem('alertCount');
