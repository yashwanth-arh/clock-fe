...
import { BranchAddEditUserComponent } from './branch-add-edit-user.component';
...
describe('BranchAddEditUserComponent', () => {
  let component: BranchAddEditUserComponent;
  let fixture: ComponentFixture<BranchAddEditUserComponent>;
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(BranchAddEditUserComponent);
  ...
  describe('validateUserForm', () => {
    it('should create a FormGroup with the correct controls', () => {
      ...
      const formControls = component.addEditUser.controls;
      expect(Object.keys(formControls)).toEqual([
        'id',
        'firstName',
        'middleName',
        'lastName',
  ...
  it('should set isSubmitted to true on form submission', () => {
    const formValue = component.addEditUser.value;
    component.onSubmit(formValue.value);
    expect(component.isSubmitted).toBe(true);
  });

  it('should return when form is invalid', () => {
    const formValue = component.addEditUser.value;
    component.addEditUser.controls['firstName'].setValue('');
    component.addEditUser.controls['lastName'].setValue('');
    component.onSubmit(formValue.value);
    expect(component.isSubmitted).toBe(true);
    expect(component.addEditUser.valid).toBe(false);
  });
