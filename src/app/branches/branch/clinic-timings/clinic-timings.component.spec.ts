...
describe('ClinicTimingsComponent', () => {
  ...
  // let matDialogRefSpy: jasmine.SpyObj<MatDialogRef<CreateBranchComponent>>;
  ...
  it('should create clinicTimingForm with all fields', () => {
    expect(component.clinicTimingForm.contains('session1ContactNumber')).toBe(true);
    expect(component.clinicTimingForm.contains('session1From')).toBe(true);
    expect(component.clinicTimingForm.contains('session1To')).toBe(true);
    expect(component.clinicTimingForm.contains('session2ContactNumber')).toBe(true);
    expect(component.clinicTimingForm.contains('session2From')).toBe(true);
    expect(component.clinicTimingForm.contains('session2To')).toBe(true);
  });
  it('should set default values for clinicTimingForm', () => {
    expect(component.clinicTimingForm.get('session1ContactNumber').value).toEqual('');
    expect(component.clinicTimingForm.get('session1From').value).toEqual('');
    expect(component.clinicTimingForm.get('session1To').value).toEqual('');
    expect(component.clinicTimingForm.get('session2ContactNumber').value).toEqual('');
    expect(component.clinicTimingForm.get('session2From').value).toEqual('');
    expect(component.clinicTimingForm.get('session2To').value).toEqual('');
  });
