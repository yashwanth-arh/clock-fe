...
import { DeviceBulkUploadDialogComponent } from './device-bulk-upload-dialog.component';
...
describe('DeviceBulkUploadDialogComponent', () => {
  let component: DeviceBulkUploadDialogComponent;
  let fixture: ComponentFixture<DeviceBulkUploadDialogComponent>;
  let appModule = new AppModule();

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [DeviceBulkUploadDialogComponent],
      imports: [
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(DeviceBulkUploadDialogComponent);
  ...
  it('should initialize uploadForm with one control', () => {
    expect(component.uploadForm.contains('uploadFile')).toBeTrue();
  });
  it('should set uploadFile control value on file select', () => {
    const file = new File(['dummy content'], 'test.txt');
    const fileInput = fixture.nativeElement.querySelector('input[type=file]');
    fileInput.dispatchEvent(new Event('change'));
    fixture.detectChanges();
    expect(component.uploadForm.get('uploadFile').value).toEqual(file);
  });
