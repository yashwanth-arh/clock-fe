...
import { HospitalAddEditUserComponent } from './hospital-add-edit-user.component';
...
describe('HospitalAddEditUserComponent', () => {
  let component: HospitalAddEditUserComponent;
  let fixture: ComponentFixture<HospitalAddEditUserComponent>;
  let appModule = new AppModule();

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [HospitalAddEditUserComponent],
      imports: [
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(HospitalAddEditUserComponent);
