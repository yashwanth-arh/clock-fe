...
import { LeadershipBoardPatientComponent } from './leadership-board-patient.component';

describe('LeadershipBoardPatientComponent', () => {
  let component: LeadershipBoardPatientComponent;
  let fixture: ComponentFixture<LeadershipBoardPatientComponent>;
  let appModule = new AppModule();
  let router: Router;
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [LeadershipBoardPatientComponent],
      imports: [
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(LeadershipBoardPatientComponent);
  ...
  it('should set patientId and patientName from route params', () => {
    const patientId = '1';
    const patientName = 'test';
    expect(patientId).toBe('1');
    expect(patientName).toBe('test');
  });
  it('should load leadership board data on init', () => {
    spyOn(component.dataSource, 'loadLeadershipBoardByPatient');
    component.ngOnInit();
    expect(component.dataSource.loadLeadershipBoardByPatient).toHaveBeenCalled();
  });
  it('should call loadLeadershipBoardByPatient on pagination and sorting changes', () => {
    spyOn(component.dataSource, 'loadLeadershipBoardByPatient');
