...
describe('TimeoutNotificationComponent', () => {
  let component: TimeoutNotificationComponent;
  let fixture: ComponentFixture<TimeoutNotificationComponent>;
  let appModule = new AppModule();

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [TimeoutNotificationComponent],
      imports: [
  ...
  it('should display the correct timeout message', () => {
    const timeoutMessage = fixture.nativeElement.querySelector('.timeout-message');
    expect(timeoutMessage.textContent).toContain('May be your internet connection strength is low!. Please check your connection and click ok to reload!.');
  });

  it('should reload the window when "Ok" is clicked', () => {
