...
import { PatientDeviceAddEditComponent } from './patient-device-add-edit.component';
...
describe('PatientDeviceAddEditComponent', () => {
  let component: PatientDeviceAddEditComponent;
  let fixture: ComponentFixture<PatientDeviceAddEditComponent>;
  let appModule = new AppModule();
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [PatientDeviceAddEditComponent],
      imports: [
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(PatientDeviceAddEditComponent);
