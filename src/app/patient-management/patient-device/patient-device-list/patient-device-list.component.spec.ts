...
import { PatientDeviceListComponent } from './patient-device-list.component';

describe('PatientDeviceListComponent', () => {
  let component: PatientDeviceListComponent;
  let fixture: ComponentFixture<PatientDeviceListComponent>;
  let appModule = new AppModule();
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [PatientDeviceListComponent],
      imports: [
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(PatientDeviceListComponent);
