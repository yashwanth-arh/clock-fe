...
import { PatientConsentFormDialogComponent } from './patient-consent-form-dialog.component';

describe('PatientConsentFormDialogComponent', () => {
  let component: PatientConsentFormDialogComponent;
  let fixture: ComponentFixture<PatientConsentFormDialogComponent>;
  let appModule = new AppModule();
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [PatientConsentFormDialogComponent],
      imports: [
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(PatientConsentFormDialogComponent);
