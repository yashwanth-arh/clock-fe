...
import { PatientConsentFormComponent } from './patient-consent-form.component';

describe('PatientConsentFormComponent', () => {
  let component: PatientConsentFormComponent;
  let fixture: ComponentFixture<PatientConsentFormComponent>;
  let appModule = new AppModule();
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [PatientConsentFormComponent],
      imports: [
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(PatientConsentFormComponent);
