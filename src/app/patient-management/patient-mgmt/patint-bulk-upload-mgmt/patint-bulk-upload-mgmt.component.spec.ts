...
import { PatintBulkUploadMgmtComponent } from './patint-bulk-upload-mgmt.component';
...
describe('PatintBulkUploadMgmtComponent', () => {
  let component: PatintBulkUploadMgmtComponent;
  let fixture: ComponentFixture<PatintBulkUploadMgmtComponent>;
  let appModule = new AppModule();
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [PatintBulkUploadMgmtComponent],
      imports: [
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(PatintBulkUploadMgmtComponent);
