...
import { RedZoneDialogComponent } from './red-zone-dialog.component';

describe('RedZoneDialogComponent', () => {
  let component: RedZoneDialogComponent;
  let fixture: ComponentFixture<RedZoneDialogComponent>;
  let appModule = new AppModule();
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [ RedZoneDialogComponent ],
      imports: [
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(RedZoneDialogComponent);
